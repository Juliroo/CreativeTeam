const config = {
	resolutionScale: 1.0,  // scale of the rendering resolution (0.5 means half the gamescreen resolution)
	...
	maxBlurSize: 30,  // by decreasing this number improves performance by reducing the number of texture samples, but it will result in a less smooth (lower quality) blur effect though.
};
...
document.addEventListener('DOMContentLoaded', () => {
    const app = document.getElementById('qbcore-inventory');
